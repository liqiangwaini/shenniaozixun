...
public abstract class BaseDanmaku {
    ...
    public final static int TAG_FLY_WORD=0x3;
    public final static int OPERA_DEL=0x4;
    public final static int OPERA_ADD=0x5;
    public final static int OPERA_READ=0x6;
    ...
    private BulletWord bulletWord;

    private ScrollNoticeWord scrollNoticeWord;
    ...
    public BulletWord getBulletWord() {
        return bulletWord;
    }

    public void setBulletWord(BulletWord bulletWord) {
        this.bulletWord = bulletWord;
    }

    public ScrollNoticeWord getScrollNoticeWord() {
        return scrollNoticeWord;
    }

    public void setScrollNoticeWord(ScrollNoticeWord scrollNoticeWord) {
        this.scrollNoticeWord = scrollNoticeWord;
    }
}
