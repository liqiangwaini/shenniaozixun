...
public class SpannedCacheStuffer extends SimpleTextCacheStuffer {
    ...
    public void measure(BaseDanmaku danmaku, TextPaint paint, boolean fromWorkerThread) {
        if (danmaku.text instanceof Spanned) {
            ...
            if (text != null) {
                //edit by wujinzhou
                StaticLayout staticLayout = new StaticLayout(text, paint, (int) StaticLayout.getDesiredWidth(danmaku.text, paint)+(int)danmaku.textSize, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
