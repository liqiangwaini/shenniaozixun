 ...
 */
public class MainRoomSocketHolder implements AsyncHttpClient.WebSocketConnectCallback,WebSocket.StringCallback,CompletedCallback{
    ...
    public MainRoomSocketHolder(String socketUrl){
