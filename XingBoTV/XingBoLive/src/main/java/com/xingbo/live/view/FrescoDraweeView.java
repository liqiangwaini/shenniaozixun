...
public class FrescoDraweeView extends SimpleDraweeView {
    ...
    public void loadImageUrlWithBlur(String url) {
        ...
        DraweeController controller = Fresco.newDraweeControllerBuilder()
                .setImageRequest(ImageRequestBuilder.newBuilderWithSource(Uri.parse(url)).setPostprocessor(new Postprocessor()).build())
                .build();
        this.setController(controller);
    }

    class Postprocessor extends BasePostprocessor {
