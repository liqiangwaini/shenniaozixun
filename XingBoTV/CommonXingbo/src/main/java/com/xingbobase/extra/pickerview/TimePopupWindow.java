 ...
 * 
 */
public class TimePopupWindow extends PopupWindow implements OnClickListener,View.OnTouchListener {
	public enum Type {
	...
	public TimePopupWindow(Context context, Type type) {
        ...
        //this.setBackgroundDrawable(new ColorDrawable(context.getResources().getColor(R.color.rgb_black_65)));// 这样设置才能点击屏幕外dismiss窗口
		...
		rootView = mLayoutInflater.inflate(R.layout.picker_view_time, null);
