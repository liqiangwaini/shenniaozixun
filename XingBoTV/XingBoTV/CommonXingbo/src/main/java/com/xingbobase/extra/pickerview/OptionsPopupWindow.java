...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener,View.OnTouchListener {
    ...
    public OptionsPopupWindow(Context context) {
        ...
        //this.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.xl_common_shadow_bg));// 这样设置才能点击屏幕外dismiss窗口
        //this.setOutsideTouchable(true);
        //this.setAnimationStyle(R.style.timepopwindow_anim_style);

        LayoutInflater mLayoutInflater = LayoutInflater.from(context);
        rootView = mLayoutInflater.inflate(R.layout.picker_view_options, null);
    ...
    public void setPicker(ArrayList<WheelItem> optionsItems) {
        wheelOptions.setPicker(optionsItems, null, null, false);
    }

    public void setPicker(ArrayList<WheelItem> options1Items,
                          ArrayList<ArrayList<WheelItem>> options2Items, boolean linkage) {
        wheelOptions.setPicker(options1Items, options2Items, null, linkage);
    }

    public void setPicker(ArrayList<WheelItem> options1Items,
                          ArrayList<ArrayList<WheelItem>> options2Items,
                          ArrayList<ArrayList<ArrayList<WheelItem>>> options3Items,
                          boolean linkage) {
