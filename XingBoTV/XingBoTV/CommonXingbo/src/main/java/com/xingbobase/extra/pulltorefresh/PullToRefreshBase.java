...
import com.xingbobase.extra.pulltorefresh.internal.LoadingLayout;
import com.xingbobase.extra.pulltorefresh.internal.RotateLoadingLayout;
import com.xingbobase.extra.pulltorefresh.internal.Utils;
import com.xingbobase.extra.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                // If we're refreshing, and the flag is set. Eat all MOVE events，如果视图正在刷新，且可强制刷新标识被设定，那么拦截
    ...
    /**
     * @return Either {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.Orientation#VERTICAL} or
     *         {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
     ...
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#REFRESHING} or {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
     *
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#RESET} state.
     */
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (mLayoutVisibilityChangesEnabled) {
            if (value < 0) {
                ...
                if (extraHeader != null) {
                    ViewHelper.setTranslationY(extraHeader, -value);
                }
            } else if (value > 0) {
     ...
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
     *
     * @author Chris Banes
     */
     ...
     * (such as sounds). See (
     * {@link com.xingbobase.extra.pulltorefresh.PullToRefreshAdapterViewBase#setOnPullEventListener}.
     *
     * @author Chris Banes
     */
    public static interface OnPullEventListener<V extends View> {
         ...
         * @param direction - One of {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
         *            {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
         *            the user is pulling. Only useful when <var>state</var> is
         *            {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
         *            {@link com.xingbobase.extra.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
         */
    ...
    public void setExtraHeaderView(View extraHeader) {
