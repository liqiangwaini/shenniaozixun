 ...
 * Date: 2016/9/5
 */
public class AnchorProtocolAct extends BaseAct implements View.OnClickListener {
    private static final String TAG="AnchorProtocolAct";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anchor_protocol_activity);
        ...
        webView.loadUrl("file:///android_asset/Anchorprotocol.html");
    }
    public void initJs(){
