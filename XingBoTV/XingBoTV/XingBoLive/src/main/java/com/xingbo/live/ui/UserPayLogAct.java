...
public class UserPayLogAct extends BaseAct implements View.OnClickListener,PullToRefreshBase.OnRefreshListener2<ListView> {
    public final static String TAG="UserPayLogAct";
    private final static int HANDLER_MSG_REFRESH_COMPLETE=0x556;
    private PullToRefreshListView refreshView;
    private ListView listView;
    private UserPayLogListAdapter mAdapter;
    private List<UserPayLogItem> payLogList=new ArrayList<UserPayLogItem>();
    ...
    private void initView(){
        refreshView = (PullToRefreshListView) findViewById(R.id.user_pay_log_pull_refresh_list);
        refreshView.setOnRefreshListener(this);
        listView = refreshView.getRefreshableView();
        listView.setDivider(null);
        mAdapter=new UserPayLogListAdapter(this, payLogList);
    ...
    private void request(int opera){
        ...
        CommonUtil.request(this, HttpConfig.API_APP_GET_USER_PAY_LOG_LIST, param, TAG, new XingBoResponseHandler<UserPayLogListModel>(this, UserPayLogListModel.class, callback) {
            @Override
            ...
            public void phpXiuSuccess(String response) {
                ...
                if (model.getD() != null) {
                    payLogList.addAll(model.getD().getItems());
                }
    ...
    public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
        if(nextPageIndex==-1){
            ...
            Toast.makeText(UserPayLogAct.this, "数据已全部加载完成", Toast.LENGTH_SHORT).show();
            return;
        }
